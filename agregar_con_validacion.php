...
<p><b>Telefono:</b><br />
  ...
  <span class="textfieldRequiredMsg">Este valor es requerido.</span><span class="textfieldInvalidFormatMsg">Formato Invalido.</span></span>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "phone_number", {format:"phone_custom", pattern:"(000) 000 00 00", hint:"Lada y numero", useCharacterMasking:true, validateOn:["blur"]});
</script>
